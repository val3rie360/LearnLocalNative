...
export default function OrgBoard() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#F6F4FE] px-0 pt-8">
      <View className="flex-1 px-5">
        ...
        <Text className="text-[#6B7280] text-[15px] mb-4 font-karla leading-[20px]">
          See what students are asking for, and gain insight through upvotes on
          posts that highlight the most requested resources and programs.
        </Text>
