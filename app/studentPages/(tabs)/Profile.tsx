    ...
    <SafeAreaView className="flex-1 bg-[#F6F4FE]" edges={["top"]}>
      <View className="flex-1 bg-[#F6F4FE] items-center pt-16">
        <View className="items-center mb-8">
          ...
          {/* Role Badge */}
          <View className={`py-1 px-3 rounded-lg ${
              ...
              {profileData.role === 'organization' && (
                <View className="flex-row justify-between items-center mb-2">
                  ...
                  <View className={`py-1 px-2 rounded ${
                    profileData.verificationFileUrl ? 'bg-green-100' : 'bg-yellow-100'
                  }`}>
                    <Text className={`text-[12px] font-karla-bold ${
                      profileData.verificationFileUrl ? 'text-green-800' : 'text-yellow-800'
                    }`}>
